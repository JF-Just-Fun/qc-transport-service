...
class UserRole
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//user_id,role_id
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = ? and role_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = ? and role_id = ?";
        return sql;
    }
